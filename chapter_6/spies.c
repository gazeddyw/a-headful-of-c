 ...
 * ***** TOP SECRET *****
 * 
 * spies.c - "Suspicious Persons Identification Expert System"
 * 
 * This can be used to record and identify persons of interest 
 */
...
int main()
{
	...
	while (1) {
		...
		free(current->question); // If current->question is already pointing to something
					 // on the heap, free that before allocating a new question
